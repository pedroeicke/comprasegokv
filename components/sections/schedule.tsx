...
const SCHEDULE_DATA: DaySchedule[] = [
    ...
    },
    {
        ...
        events: [
            ...
            { time: "9h10", title: "Debates", type: "debate" },
            { time: "9h50", title: "Coffee break", type: "coffee" },
            { time: "10h20", title: "Aquisição de cães policiais", speaker: "Vitor Valle", speakerRole: "Coronel de Polícia Militar", speakerImage: "/profok/vitor.jpeg", type: "palestra" },
            { time: "10h55", title: "Estudos para aquisição de equinos para a polícia montada", speaker: "Syllas Jadach", speakerRole: "Tenente-Coronel de Polícia Militar", speakerImage: "/profok/SYLLAS.png", type: "palestra" },
            { time: "11h30", title: "Debates", type: "debate" },
            { time: "12h", title: "Intervalo para o almoço", type: "almoco" },
        ]
    },
    {
        ...
        events: [
            ...
            { time: "16h55", title: "Exigência de marcas e proibição de marcas em licitações da Segurança Pública", speaker: "Noel Baratieri", speakerRole: "Advogado", speakerImage: "/profok/noel.jpeg", type: "palestra" },
            { time: "17h30", title: "Debates", type: "debate" },
            { time: "18h", title: "Encerramento", type: "encerramento" },
