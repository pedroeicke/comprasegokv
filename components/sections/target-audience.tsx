        ...
        <section id="publico" className="w-full relative bg-transparent pt-24 pb-24 overflow-hidden">
            ...
            <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                    ...
                    {/* CARD 4: EMPRESAS DE DEFESA (NOVO) */}
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                    ...
                    >
                        <div className="p-8 border-b border-[#00C1FF]/20 bg-[#00C1FF]/5">
                            <h3 className="text-xl font-display font-bold text-white uppercase mb-4 leading-tight">Empresas de Defesa e Segurança</h3>
                        </div>
                        <div className="p-6 flex-1 bg-black/20">
                            <ul className="space-y-3">
                                {DEFENSE_COMPANIES.map((org, i) => (
                                    <li key={i} className="flex items-start gap-3 text-tactical-metal group-hover:text-white transition-colors">
                                        <span className="text-sm font-medium uppercase tracking-wide leading-snug">{org.name}</span>
                                    </li>
                                ))}
                            </ul>
                        </div>
