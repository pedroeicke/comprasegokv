                ...
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <a href="https://wa.me/5548996547282" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 rounded-lg bg-white/5 hover:bg-white/10 transition-colors border border-white/5">
                                <svg
                                ...
                                <span className="text-white font-medium">(48) 99654-7282</span>
                            </a>
